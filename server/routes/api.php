...
Route::delete('/delete-item/{id}', [TasksController::class, 'destroy']);

Route::get('/thoughts', [ThoughtsController::class, 'index']);
Route::post('/add-thought', [ThoughtsController::class, 'store']);
// Route::put('/update-item/{id}', [TasksController::class, 'update']);
Route::delete('/delete-thought/{id}', [ThoughtsController::class, 'destroy']);
